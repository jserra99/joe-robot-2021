...
class DriveTrain:
	...
	def __init__(self, config):
		self.frontLeft = SwerveModule(7,8,0,config["Front Left"],"Front Left") #drive ID, turn ID, encoder ID, encoder offset
		self.frontRight = SwerveModule(1,2,2,config["Front Right"],"Front Right")
		self.rearLeft = SwerveModule(5,6,3,config["Rear Left"],"Rear Left")
		self.rearRight = SwerveModule(3,4,1,config["Rear Right"], "Rear Right")
	...
	def giveAbsolutes(self):
		return self.frontLeft.returnAbsolutes(), self.frontRight.returnAbsolutes(), self.rearLeft.returnAbsolutes(), self.rearRight.returnAbsolutes()
